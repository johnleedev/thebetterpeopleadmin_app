...
export default function NursingMain (props : any) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* title */}
      <Title title='간호하는대학생들' enTitle='StudentsNursing'/>
